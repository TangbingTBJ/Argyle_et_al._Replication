...
short_2012_political_interest_train, short_2012_political_interest_test = train_test_split(
    pi_2012, test_size=0.85, random_state=1998, stratify=pi_2012["political_interest"])
...
compiled_model = optimizer.compile(model, trainset=train_set)
compiled_model.save("political_interest_2012_model.json")

compiled_model
compiled_model.save("political_interest_2012_model.json")
compiled_model.save("political_interest_2012_model.pkl")
...
short_2016_political_interest_train, short_2016_political_interest_test = train_test_split(
    pi_2016, test_size=0.85, random_state=4, stratify=pi_2016["political_interest"])
...
model = PoliticalInterestPredictor()
compiled_model_2016 = optimizer.compile(model, trainset=train_set)
compiled_model_2016.save("political_interest_2016_model.json")

compiled_model_2016
compiled_model_2016.save("political_interest_2016_model.json")
compiled_model_2016.save("political_interest_2016_model.pkl")
